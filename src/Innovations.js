...
<div class="main-container">
    <div class="innovation-container" id='innovation-container-1'>
        <div class="innovation-items" id="innovation-item-1">
            <img src={require("./assets/img/innovations-img/medi-prod.jpg")} alt="Medical products" />
        ...
        <div class="innovation-items" id="innovation-item-2">
            <img src={require("./assets/img/innovations-img/bio-prod.jpg")} alt="Biomaterials"/>
            <div class="overlapping-div">
                <h1>Biomaterials</h1>
                <div class="underline"></div>
            </div>
        ...
        <div class="innovation-items" id="innovation-item-3">
            <img src={require("./assets/img/innovations-img/home-auto.jpg")} alt="Home automation system" />
            <div class="overlapping-div">
                <h1>Smart Devices</h1>
                <div class="underline"></div>
            </div>
        ...
        <div class="innovation-items" id="innovation-item-6">
            <img src={require("./assets/img/innovations-img/baby-prod.jpg")} alt="Baby care" />
            <div class="overlapping-div">
                <h1>Baby Care</h1>
                <div class="underline"></div>
            </div>
