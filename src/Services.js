...
<div class="main-container">
	<div class="service-container" id='service-container-1'>
		<div class="service-items" id="service-item-1">
			<img src={require("./assets/img/services-img/drone.jpg")} alt="service-img" />
		...
		<div class="service-items" id="service-item-2">
			<img src={require("./assets/img/services-img/autocad.jpg")} alt="service-img"/>
		...
		<div class="service-items" id="service-item-3">
			<img src={require("./assets/img/services-img/3dScanning.jpg")} alt="service-img" />
			<div class="overlapping-div">
				<h1>3D Scanning</h1>
		...
		<div class="service-items" id="service-item-4">
			<img src={require("./assets/img/services-img/prototype.jpg")} alt="service-img" />
			<div class="overlapping-div">
				<h1>Prototype</h1>
	...
	<div class="service-container" id='service-container-2'>
		<div class="service-items" id="service-item-5">
			<img src={require("./assets/img/services-img/design.jpg")} alt="service-img"/>
				{/* // style="border: 1px solid #ddd; box-shadow: 2px 3px #ddd;" */}
			<div class="overlapping-div">
				<h1>Design</h1>
		...
		<div class="service-items" id="service-item-6">
			<img src={require("./assets/img/services-img/soft-tooling.jpg")} alt="service-img"/>
			<div class="overlapping-div">
				<h1>Soft Tooling</h1>
		...
		<div class="service-items" id="service-item-7">
			<img src={require("./assets/img/services-img/gifts.jpg")} alt="service-img"/>
			<div class="overlapping-div">
