...
export default function Education() {
  return (
    <>
      ...
      <div class="main-container">
        <div class="edu-item" id="edu-item-0">
          <img src={require("./assets/img/education-img/drone-train.jpg")}
      ...
      <div class="edu-item" id="edu-item-1">
		<img src={require("./assets/img/education-img/training.jpg")}
			alt="Industrial Training and Placement" />
		<div class="img-desc">
    ...
    <div class="edu-item" id="edu-item-2">
		<img src={require("./assets/img/education-img/college-project.jpg")} alt="Academic Projects" />
		<div class="img-desc">
	...
	<div class="edu-item" id="edu-item-3">
		<img src={require("./assets/img/education-img/workshop-printing.jpg")} alt="3D Printing" />
		<div class="img-desc">
			<h2>3D Printing</h2>
	...
	<div class="edu-item" id="edu-item-4">
		<img src={require("./assets/img/education-img/workshop-thinking.jpg")} alt="Design Thinking" />
		<div class="img-desc">
	...
	<div class="edu-item" id="edu-item-5">
		<img src={require("./assets/img/education-img/workshop-softwares.jpg")} alt="Design Software"/>
		<div class="img-desc">
	...
	<div class="edu-item" id="edu-item-6">
		<img src={require("./assets/img/education-img/internships.jpg")} alt="Internships" />
		<div class="img-desc">
			<h2>Internships</h2>
