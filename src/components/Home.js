...
import contact_img from "../assets/img/home-img/contact-img.jpg";
  ...
  return (
    <>
      ...
      <div class="about-container">
        <img src={require("../assets/img/home-img/about-img.jpg")} alt="About us" />
      ...
      <div class="team-container" id="team">
        ...
        <div class="team-items">
          <div class="team-item">
            <img src={require("../assets/img/team-img/DK.jpeg")} alt="Dinesh Kandukuri" />
          ...
          <div class="team-item">
            <img src={require("../assets/img/team-img/KB.jpeg")} alt="Kanika Bansal" />
            <h5>Kanika Bansal</h5>
            <h6>Director</h6>
      ...
      <div class="contact-container" id="contact" >
        <div class="contact-part" id="contact-part-1" >
          ...
          <div class="contact-item" id="contact-item-2">
            <img src={require("../assets/img/home-img/contact-img.jpg")} alt="Contact Us" />
          </div>
        ...
        <div class="logo-container">
          ...
          <div class="logo-item">
            <a href="http://www.siicincubator.com">
              <img src={require("../assets/img/iitk.jpg")} alt="IIT-Kanpur" />
              <div class="para">
          ...
          <div class="logo-item">
            ...
            <img src={require("../assets/img/nttdata.png")} alt="We-Hub" />
            <div class="para">
          ...
          <div class="logo-item">
            ...
            <img src={require("../assets/img/we-hub.jpg")} alt="We-Hub" />
            <div class="para">
          ...
          <div class="logo-item">
            <img src={require("../assets/img/TSIC.jpg")} alt="We-Hub" />
            <div class="para">
          ...
          <div class="logo-item">
            <img src={require("../assets/img/start-up.jpg")} alt="Start-up India" />
            <div class="para">
          ...
          <div class="logo-item">
            <img src={require("../assets/img/amtz.jpg")} alt="IIT-Kanpur" />
            <div class="para">
